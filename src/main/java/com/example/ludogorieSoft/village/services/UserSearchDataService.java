...
public class UserSearchDataService {
    ...
    private void checkBuiltUpAreaValidations(UserSearchDataDTO userSearchDataDTO) {
        if (userSearchDataDTO.getMinBuiltUpArea() != null && userSearchDataDTO.getMinBuiltUpArea() < 0)
            throw new ApiRequestException("Minimal built up area can not be less than 0!");
        if (userSearchDataDTO.getMaxBuiltUpArea() != null && userSearchDataDTO.getMaxBuiltUpArea() < 0)
            throw new ApiRequestException("Maximal built up area can not be less than 0!");
    ...
    private void checkYardAreaValidations(UserSearchDataDTO userSearchDataDTO) {
        if (userSearchDataDTO.getMinYardArea() != null && userSearchDataDTO.getMinYardArea() < 0)
            throw new ApiRequestException("Minimal yard area can not be less than 0!");
        if (userSearchDataDTO.getMaxYardArea() != null && userSearchDataDTO.getMaxYardArea() < 0)
            throw new ApiRequestException("Maximal yard area can not be less than 0!");
    ...
    private void checkRoomsCountValidations(UserSearchDataDTO userSearchDataDTO) {
        if (userSearchDataDTO.getMinRoomsCount() != null && userSearchDataDTO.getMinRoomsCount() < 0)
            throw new ApiRequestException("Minimal room count can not be less than 0!");
        if (userSearchDataDTO.getMaxRoomsCount() != null && userSearchDataDTO.getMaxRoomsCount() < 0)
            throw new ApiRequestException("Maximal room count can not be less than 0!");
    ...
    private void checkBathroomsCountValidations(UserSearchDataDTO userSearchDataDTO) {
        if (userSearchDataDTO.getMinBathroomsCount() != null && userSearchDataDTO.getMinBathroomsCount() < 0)
            throw new ApiRequestException("Minimal bathroom count can not be less than 0!");
        if (userSearchDataDTO.getMaxBathroomsCount() != null && userSearchDataDTO.getMaxBathroomsCount() < 0)
            throw new ApiRequestException("Maximal bathroom count can not be less than 0!");
    ...
    private void checkConstructionYearValidations(UserSearchDataDTO userSearchDataDTO) {
        if (userSearchDataDTO.getMinConstructionYear() != null && userSearchDataDTO.getMinConstructionYear() < 0)
            throw new ApiRequestException("Minimal construction year can not be less than 0!");
        if (userSearchDataDTO.getMaxConstructionYear() != null && userSearchDataDTO.getMaxConstructionYear() < 0)
            throw new ApiRequestException("Maximal construction year can not be less than 0!");
    ...
    private void checkPriceValidations(UserSearchDataDTO userSearchDataDTO) {
        ...
        if (userSearchDataDTO.getMinPrice() != null && userSearchDataDTO.getMinPrice().compareTo(zero) < 0)
            throw new ApiRequestException("Minimal price can not be less than 0!");
        if (userSearchDataDTO.getMaxPrice() != null && userSearchDataDTO.getMaxPrice().compareTo(zero) < 0)
            throw new ApiRequestException("Maximal price can not be less than 0!");
