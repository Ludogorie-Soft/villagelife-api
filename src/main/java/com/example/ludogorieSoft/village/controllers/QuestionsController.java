...
public class QuestionsController {
    ...
    @PostMapping
    public ResponseEntity<QuestionsDTO> createQuestion(@RequestBody Questions question, UriComponentsBuilder uriComponentsBuilder) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<QuestionsDTO> updateQuestion(@PathVariable("id") Long id, @RequestBody Questions question) {
